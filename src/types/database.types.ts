...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      clone_session_drills: {
        Args: { p_source_session_id: string }
        Returns: number
      }
      complete_season: { Args: { p_season_id: string }; Returns: undefined }
      ...
      delete_cohort: { Args: { p_cohort_id: string }; Returns: undefined }
      delete_drill: { Args: { p_drill_id: string }; Returns: undefined }
      delete_player: { Args: { p_player_id: string }; Returns: undefined }
      ...
      require_system_admin: { Args: never; Returns: undefined }
