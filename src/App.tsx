...
const highlights: Array<{
...
}> = [
  {
    ...
    description:
      "Custom violet palette, surfaces, and glow shadows are ready for shadcn/ui components.",
  },
  {
    icon: Users2,
    title: "Responsive by design",
    description:
      "Tailored breakpoints keep evaluators productive on rink tablets, laptops, and control-center displays.",
  },
  {
    icon: ClipboardList,
  ...
  {
    icon: BarChart3,
    title: "QA-first reporting",
    description:
      "Outlier detection and evaluator coverage metrics will surface immediately in dashboards.",
  },
];
