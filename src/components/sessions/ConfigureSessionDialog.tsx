...
export function ConfigureSessionDialog({
  ...
  useEffect(() => {
    if (open && session && currentAssociation) {
      setSessionDrills([]);
      setActiveDrills([]);
      setPositions([]);
      setFeedback(null);
  ...
  }, [open, session, currentAssociation]);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[80vw] max-h-[90vh] flex flex-col">
        <DialogHeader>
          <DialogTitle>Configure Session Drills</DialogTitle>
          <DialogDescription>
            Manage drill assignments and weights.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-2 gap-4 py-4 text-sm border-b mb-4">
          ...
          <div>
            <span className="text-muted-foreground block text-xs">Cohort</span>
            <span className="font-medium">{session.cohort?.name || "-"}</span>
          </div>
          <div>
            <span className="text-muted-foreground block text-xs">
              Date / Time
        ...
        <div className="flex-1 overflow-y-auto pr-2">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-blue-200 bg-blue-50 p-5 h-fit dark:bg-blue-900/20 dark:border-blue-800">
              ...
              <div className="space-y-4 text-sm dark:text-blue-200/80">
                ...
                <div className="space-y-1">
                  <p className="font-medium dark:text-blue-100">Assignments</p>
                  <p>
                    Drills are assigned to specific positions. A single drill
                    can apply to multiple positions with the same weight.
                  </p>
                </div>
              </div>
            </div>
