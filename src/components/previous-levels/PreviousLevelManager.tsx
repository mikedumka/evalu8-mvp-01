...
export function PreviousLevelManager() {
    ...
    return (
      <section className="rounded-3xl border border-white/10 bg-surface-900/60 p-6 text-surface-200 shadow-glow">
        <h2 className="flex items-center gap-2 text-lg font-semibold text-white">
          <Medal className="h-5 w-5 text-brand-300" />
          Previous Levels
        </h2>
  ...
  return (
    <section className="rounded-3xl border border-white/10 bg-surface-900/60 p-6 text-surface-100 shadow-glow">
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-surface-950/50 p-5">
        {loading ? (
          <div className="flex items-center justify-center py-8 text-sm text-surface-300">
            Loading previous levels…
          </div>
        ) : sortedLevels.length === 0 ? (
          <div className="rounded-xl border border-dashed border-white/10 bg-surface-900/50 px-4 py-6 text-center text-sm text-surface-300">
                  ...
                  <article className="rounded-2xl border border-white/10 bg-surface-900/60 p-4">
                    <div className="flex flex-col gap-2 text-sm">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded-full border border-white/10 px-3 py-1 text-xs font-medium text-surface-200 transition hover:border-brand-300 hover:text-white"
                      ...
                      <p className="text-[11px] uppercase tracking-[0.35em] text-surface-500">
                        Players this season:
                        <span className="ml-1 text-surface-100">{players}</span>
                      </p>
                    </div>
                  </article>
                </li>
