-- Function to activate a season and deactivate the current one
...
BEGIN
  ...
  IF v_season.association_id <> v_association_id THEN
    RAISE EXCEPTION 'Access denied for this season';
  END IF;
  ...
  -- Deactivate currently active season(s)
...
-- Function to safely delete a season
